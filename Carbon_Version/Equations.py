...
# *****************************************************************************************************************
nGRT = 20		#Number of chemical reaction equations = Number of Gibbs free energy terms
...
species = [
	...
	'Fe_metal', 'Si_metal', 'O_metal', 'H_metal', 'C_metal',
	'H2_gas', 'CO_gas', 'CO2_gas', 'CH4_gas', 'O2_gas', 'H2O_gas',
	'Fe_gas', 'Mg_gas', 'SiO_gas', 'Na_gas']
...
# f18: C (metal) + O (metal) <-> CO (melt)
f18 = log(var['C_metal']) + log(var['O_metal']) - log(var['CO_silicate']) + lngCmetal + GRT_T[19]

# Mass conservation
m0 = 1.0 - (var['Moles_silicate'] * (var['SiO2_silicate'] + var['MgSiO3_silicate'] + var['FeSiO3_silicate'] + var['Na2SiO3_silicate']) + var['Si_metal'] * var['Moles_metal'] + (var['SiO_gas']) * var['Moles_atm']) / nSi
...
m4 = 1.0 - (var['Moles_metal'] * var['H_metal'] + var['Moles_silicate'] * (2.0 * var['H2_silicate'] + 2.0 * var['H2O_silicate']) + var['Moles_atm'] * (2.0 * var['H2_gas'] + 2.0 * var['H2O_gas'] + 4.0 * var['CH4_gas'])) / nH

m5 = 1.0 - (var['Moles_silicate'] * (2.0 * var['Na2O_silicate'] + 2.0 * var['Na2SiO3_silicate']) + var['Moles_atm'] * var['Na_gas']) / nNa

m6 = 1.0 - (var['Moles_silicate'] * (var['CO_silicate'] + var['CO2_silicate']) + var['Moles_atm'] * (var['CO2_gas'] + var['CH4_gas'] + var['CO_gas']) + var['Moles_metal'] * var['C_metal']) / nC
...
#metal
s1 = 1.0 - var['Fe_metal'] - var['Si_metal'] - var['O_metal'] - var['H_metal'] - var['C_metal']
#atmosphere
s2 = 1.0 - var['H2_gas'] - var['CO_gas'] - var['CO2_gas'] - var['CH4_gas'] - var['O2_gas'] - var['H2O_gas'] - var['Fe_gas'] - var['Mg_gas'] - var['SiO_gas' ] - var['Na_gas']
...
# Temporary varialbles can be used freely, but the result must be stored in the variable 'P'.
# *****************************************************************************************************************
# *****************************************************************************************************************
